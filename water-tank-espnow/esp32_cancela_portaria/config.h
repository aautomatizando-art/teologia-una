...
#define AP_CONFIG_NOME   "CancelaPortaria-Setup"
...
// ─── PINOS ESP32 CANCELA DA PORTARIA ─────────────────────────────────
// Contatos secos (rele) ligados ao GND quando ativos -> usa INPUT_PULLUP
// (pino em HIGH = inativo, pino em LOW = ativo)
#define ENTRADA1_PIN    27   // ENTRADA 1: Cancela 1 em falha
#define ENTRADA2_PIN    14   // ENTRADA 2: Cancela 2 em falha
